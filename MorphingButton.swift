            ...
            .fullScreenCover(isPresented: $showFullScreenCover) {
                ...
                .background {
                    RoundedRectangle(cornerRadius: 30, style: .continuous)
                        ...
                        .ignoresSafeArea(showExpandedContent ? .all : [])
                }
                ...
                .task {
                    ...
                    withAnimation(.interpolatingSpring(duration: animationDuration, bounce: 0)) {
                        animateContent = true
                    }
                }
                .animation(.interpolatingSpring(duration: animationDuration, bounce: 0), value: showExpandedContent)
